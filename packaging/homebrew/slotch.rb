...
#   brew install --cask <ton-user-github>/tap/slotch
cask "slotch" do
  version "1.0"
  sha256 "REMPLACER_PAR_LE_SHA256_AFFICHE_PAR_RELEASE_SH"

  url "https://github.com/REMPLACER_USER/slotch/releases/download/v#{version}/Slotch-#{version}.dmg"
  name "Slotch"
  desc "Slot machine hiding behind your Mac's notch"
  homepage "https://github.com/REMPLACER_USER/slotch"
